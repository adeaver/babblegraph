...
const (
	...
	insertUserReadability                  = "INSERT INTO user_readability_level (user_id, language_code, version, readability_level) VALUES ($1, $2, $3, $4)"
)
...
func insertUserReadability(tx *sqlx.Tx, userID users.UserID, languageCode wordsmith.LanguageCode, level int) error {
	_, err := tx.Exec(insertUserReadability, userID, languageCode, version1, level)
	return err
}
