...
const translations = {
    [DisplayLanguage.English]: {
        ...
        [TextBlock.IntroParagraph2]: "Why do you need to sign up for an account to pay for your Babblegraph subscription?",
        [TextBlock.IntroParagraph3]: "Security is a big concern when dealing with payment information. Having a password-protected account will give you better security.",
