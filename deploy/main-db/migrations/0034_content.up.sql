...
CREATE UNIQUE INDEX IF NOT EXISTS content_source_url_identifier ON content_source(url_identifier);
...
ALTER TABLE content_source_seed ADD COLUMN IF NOT EXISTS url_params TEXT;
CREATE UNIQUE INDEX IF NOT EXISTS content_source_seed_url_identifier ON content_source_seed(url_identifier, url_params);
